...
class DataLoader:
    ...
    def icf_participant(self,data_mab,data_random,data_choi):
        ...
        self.plot_slope(data_mab,ax,0)
        self.plot_slope(data_random,ax,1)
        self.plot_slope(data_choi,ax,2)
